...
$package = Join-Path $stagingRoot 'LabPhotoTools-0.1.14-preview'
...
$zip = Join-Path $dist 'LabPhotoTools-0.1.14-preview.zip'
...
$sourcePackage = Join-Path $stagingRoot 'LabPhotoTools-0.1.14-source'
...
Compress-Archive -LiteralPath $sourcePackage -DestinationPath (Join-Path $dist 'LabPhotoTools-0.1.14-source.zip') -Force
