...
$package = Join-Path $stagingRoot 'LabPhotoTools-0.1.13-preview'
...
$zip = Join-Path $dist 'LabPhotoTools-0.1.13-preview.zip'
...
$sourcePackage = Join-Path $stagingRoot 'LabPhotoTools-0.1.13-source'
...
Compress-Archive -LiteralPath $sourcePackage -DestinationPath (Join-Path $dist 'LabPhotoTools-0.1.13-source.zip') -Force
