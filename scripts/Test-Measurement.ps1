...
& (Join-Path $framework 'csc.exe') /nologo /target:exe /platform:anycpu /main:MeasurementTests ('/out:'+$exe) $references $sources (Join-Path $root 'tests\MeasurementTests.cs')
